export enum UserPermission {
  ...
  // Credenciales
  ADD_CREDENCIALES = "add_credenciales",
  CHANGE_CREDENCIALES = "change_credenciales",
  DELETE_CREDENCIALES = "delete_credenciales",
  VIEW_CREDENCIALES = "view_credenciales",

  // Historial de Estado
  ADD_HISTORIALESTADO = "add_historialestado",
  CHANGE_HISTORIALESTADO = "change_historialestado",
  DELETE_HISTORIALESTADO = "delete_historialestado",
  VIEW_HISTORIALESTADO = "view_historialestado",

  // Historial de Baja
  ADD_HISTORIALBAJA = "add_historialbaja",
  CHANGE_HISTORIALBAJA = "change_historialbaja",
  DELETE_HISTORIALBAJA = "delete_historialbaja",
  VIEW_HISTORIALBAJA = "view_historialbaja",

  // Tipo de Régimen Laboral
  ADD_TIPOREGIMENLABORAL = "add_tiporegimenlaboral",
  CHANGE_TIPOREGIMENLABORAL = "change_tiporegimenlaboral",
  DELETE_TIPOREGIMENLABORAL = "delete_tiporegimenlaboral",
  VIEW_TIPOREGIMENLABORAL = "view_tiporegimenlaboral",
